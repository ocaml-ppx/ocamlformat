...
#### Changes
  ...
  + Auto mode for break-string-literals instead of {wrap,newlines,newlines-and-wrap} (#1057) (Guillaume Petiot)
  + Dock collection brackets (#1014) (Guillaume Petiot)
  + Preserve begin-end keywords in if-then-else (#978) (Jules Aguillon)
...
#### Internal
  ...
  + Remove the bisect_ppx dependency and clean Makefile (#1005) (Jules Aguillon)
  ...
  + Change the type of fmt-code (#974) (Guillaume Petiot)
