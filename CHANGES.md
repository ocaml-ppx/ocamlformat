...
#### Changes
  ...
  + Preserve bracketed lists in the Parsetree (#1694, #1876, @gpetiot).
    `(::)`-lists are no longer normalized into bracketed lists for the default and ocamlformat profiles, the normalization is preserved for the janestreet profile (#1914, @gpetiot).
