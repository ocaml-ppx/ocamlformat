No redundant values:
  ...
  break-collection-expressions=wrap-or-vertical (profile default (file .ocamlformat:1))
...
Redundant values from the ocamlformat profile:
  ...
  break-collection-expressions=wrap-or-vertical (profile ocamlformat (file .ocamlformat:1))
