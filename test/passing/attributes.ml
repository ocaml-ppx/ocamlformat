...
let _ =
  ...
  @ b_____________________________________ ) [@a]

(* Attribute should wrap as a block *)
let _ =
  ( a_______________________________________________________________________
  @ b_______________________________________________________________ ) [@a]

let _ =
  ( a________________________________________________________________
  @ b________________________________________________________________ ) [@a]
