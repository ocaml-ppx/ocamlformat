...
let transform_array_length : fooooooooo -> f:fooooooooooooooo -> fooooo =
 fun foooooooooooo ->
  { v with
    foooooooooooooooooooooooooooooooooooooooooooooooo
  ; fooooo= foooooooooooooooooooooooooooooooooooooooooooooooo }
...
let fooooooooooooooooo =
  fooooooooooooooooooooooo |> (ignore : Itv.t list -> unit) ;
...
let fooooooooooooooooooooooooooooooooooooooo =
  fooooooooooooooooooooooooooooooooooooooooo ;
  { foooooooooooooooooooooooooooooooo
  ; foooooooooooooooooooooooooooooooooooooooooooooooo }
...
let foooooo fooo fooo fooo =
  { fooo; foooo= fooooo_foooo foo.fooo; foooo= Foooo.foooo fooooo fooo.foo }

let foooooooooooooooooooooooo =
  Foo_foooooooooooooo_foooooooo
    { foooooooooooooooooooo= false; foooooo= Fooo.foooooooooooooooooooo }

let foooooooooooooooooooooooo =
  Foo_foooooooooooooo_foooooooo
    { foooooooooooooooooooo= false
    ; foooooooooooo
    ; foooooo= Fooo.foooooooooooooooooooo
    }
...
let foooooooooooooooooooooooo =
  Foo_foooooooooooooo_foooooooo
    [ foooooooooooooooooooofoooooooooo
    ; foooooooooooofooooooooooooo
    ; foooooofoooooooooooooooooooo
    ]

[@@@ocamlformat "space-around-arrays=true"]
