...
open Uucp_tmap
let nfkc_simple_fold_map_map : [ `Self | `Uchars of Uchar.t list ] t =
  { default = `Self;
    l0 =
     [|[|nil; nil; nil; nil;
         ...
         [|(`Uchars [Uchar.unsafe_of_int 0x00F0;]);
           ...
           (`Uchars [Uchar.unsafe_of_int 0x00FE;]); `Self|];
         nil; nil;
       ...
       [|nil; nil; nil; nil; nil; nil; nil; nil; nil; nil;
         ...
         [|(`Uchars [Uchar.unsafe_of_int 0x1E91;]); `Self;
           ...
           (`Uchars [Uchar.unsafe_of_int 0x00DF;]); `Self|];
         ...
         [|`Self; `Self; `Self; `Self; `Self; `Self; `Self; `Self;
           (`Uchars [Uchar.unsafe_of_int 0x1F80;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F81;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F82;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F83;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F84;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F85;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F86;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F87;])|];
         [|`Self; `Self; `Self; `Self; `Self; `Self; `Self; `Self;
           (`Uchars [Uchar.unsafe_of_int 0x1F90;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F91;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F92;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F93;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F94;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F95;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F96;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F97;])|];
         [|`Self; `Self; `Self; `Self; `Self; `Self; `Self; `Self;
           (`Uchars [Uchar.unsafe_of_int 0x1FA0;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FA1;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FA2;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FA3;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FA4;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FA5;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FA6;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FA7;])|];
         [|`Self; `Self; `Self; `Self; `Self; `Self; `Self; `Self;
           (`Uchars [Uchar.unsafe_of_int 0x1FB0;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FB1;]);
           (`Uchars [Uchar.unsafe_of_int 0x1F70;]);
           (`Uchars [Uchar.unsafe_of_int 0x03AC;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FB3;]);
         ...
         [|(`Uchars [Uchar.unsafe_of_int 0x0020;Uchar.unsafe_of_int 0x0342;]);
           ...
           (`Uchars [Uchar.unsafe_of_int 0x03AE;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FC3;]);
           (`Uchars
         ...
         [|`Self; `Self; `Self; `Self; `Self; `Self; `Self; `Self;
           ...
           (`Uchars [Uchar.unsafe_of_int 0x03CE;]);
           (`Uchars [Uchar.unsafe_of_int 0x1FF3;]);
           (`Uchars [Uchar.unsafe_of_int 0x0020;Uchar.unsafe_of_int 0x0301;]);
